...
\newcommand{\documentAuthor}{Maximilian Bender von Säbelkampf, Kevin Basener}
\newcommand{\documentTitle}{Evaluation des Model View Controllers}
...
\newcommand{\lecture}{Advanced Software-Engineering}
% Whether to show the lecture on cover
\newcommand{\showLecture}{false}

\newcommand{\releaseDate}{Dezember 2024}
